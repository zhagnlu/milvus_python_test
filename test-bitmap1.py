...
if True:
    if True:
        index_param = { "index_type" : "BITMAP", "bitmap_cardinality_limit" : 10 }
    ...
    #----------------------------------------------------------------
        ...
        index_param = { "index_type" : "BITMAP", "bitmap_cardinality_limit" : 10 }
        #hello_milvus.create_index("double1", index_param)
        #hello_milvus.create_index("array3", index_param)
else:
    index_param = { "index_type" : "AUTOINDEX", "bitmap_cardinality_limit" : 10 }
    #hello_milvus.create_index("string1", index_param)
    hello_milvus.create_index("int1", index_param)
    hello_milvus.create_index("int8_1", index_param)
    hello_milvus.create_index("bool1", index_param)
