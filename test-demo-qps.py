...
fields = [
    ...
    FieldSchema(name="string1", dtype=DataType.VARCHAR, max_length=20000,  enable_analyzer=True, enable_match=True),
    FieldSchema(name="string2", dtype=DataType.VARCHAR, max_length=20000,  enable_analyzer=True, enable_match=True),
...
def perform_queries(num_queries  = 1):
  ...
  for _ in range(num_queries):
    ...
    # print(len(result))
     result = hello_milvus.query(expr="string1 like '%abc%' && string1 like '%def%' ")
     print(result) 
     result = hello_milvus.query(expr="string1 like '%def%' && string1 like '%abc%' ")
     print(result)
